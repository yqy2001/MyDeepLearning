...
def load_FashionMNIST(bsz):
    ...
    train_data = torchvision.datasets.FashionMNIST(root="dataset", train=True, transform=trans, download=True)
    test_data = torchvision.datasets.FashionMNIST(root="dataset", train=False, transform=trans, download=True)
...
if __name__ == '__main__':
    dataloader = load_FashionMNIST(32)
    timer = d2l.Timer()
